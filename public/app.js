...
const CHAT_ID = "REPLACE_WITH_CHAT_ID"; // TODO: replace with your chat id (e.g., 5720447582)
...
const dict = {
  ru: {
    ...
    video: "Видео",
    hint: "360° обход снаружи и внутри • каждое колесо и ступица • потолок изнутри • все углы • двери (распашные/рольставни), петли, уплотнители, замки",
  ...
  en: {
    ...
    pickup: "Pickup time",
    video: "One video",
    hint: "360° walk-around inside and out • each tire and wheel-end • interior roof/ceiling • all corners • doors (swing/roll-up), hinges, seals, latches",
